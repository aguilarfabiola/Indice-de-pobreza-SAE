# Paquetes a usar
lista_paquetes <- c("dplyr", "ggplot2", "lubridate", "tidyr", "kableExtra", "flextable", "filesstrings","forcats",'writexl',"sf",
                    "purrr", "readr", "extrafont", "stringr", "ggmap", "readxl", "leaflet", "mapview", "purrr", "haven","sae")
